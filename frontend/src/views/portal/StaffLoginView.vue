...
<template>
  <main class="min-h-screen bg-background text-on-surface flex flex-col">
    <div class="flex-1 flex items-center justify-center px-margin-mobile py-2xl">
      <section class="w-full max-w-md bg-white rounded-xl card-shadow border border-outline-variant/40 p-xl">
        <RouterLink class="inline-flex items-center gap-sm mb-xl" to="/">
          ...
          <span class="font-headline-md text-headline-md text-primary font-bold">Montserrado County YMCA</span>
        </RouterLink>
